...
- **Composio** — Stage 4 only: register Hermite's `/api` as a Composio toolkit rather than hand-building an MCP server; this is the integration layer that lets Cursor and other MCP agents call Hermite as a tool
